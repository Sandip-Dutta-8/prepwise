...
import type { Interviewer } from "@/actions/explore";
import type { InterviewCategory } from "@/lib/generated/prisma/enums";
...
export default function ExploreGrid({ interviewers }: ExploreGridProps) {
    const [activeCategory, setActiveCategory] = useState<InterviewCategory | null>(
        null
    );

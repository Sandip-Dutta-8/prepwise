...
import { bookSlot, type InterviewerProfile } from "@/actions/booking";
...
// Shape returned by `generateSlots`. Adjust to match its actual return type
// if this doesn't line up with lib/helpers.
interface TimeSlot {
    startTime: Date;
    endTime: Date;
    available: boolean;
...
export default function SlotPicker({
    ...
    // useFetch's exact generic signature isn't available here — this assumes
    // it mirrors bookSlot's (params, result) types. Adjust if your hook's
    // signature differs.

...
export default function AIQuestionsPanel({ categories }: AIQuestionsPanelProps) {
    ...
    const {
        ...
        error,
        fn: generateFn,
    } = useFetch<GenerateInterviewQuestionsResult, [{ category: Category }]>(
    ...
    return (
        <div className="flex flex-col gap-4 h-full overflow-hidden">
            ...
            <Button
                ...
                onClick={() =>
                    selectedCategory && generateFn({ category: selectedCategory })
                }

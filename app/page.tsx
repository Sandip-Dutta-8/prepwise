...
function MockUI({ rows = 3 }: MockUIProps) {
...
function AuroraBackground() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      <div className="absolute -top-40 left-1/4 w-[500px] h-[500px] bg-amber-400/20 rounded-full blur-[120px] animate-pulse" />
      <div
        className="absolute top-20 right-1/4 w-[400px] h-[400px] bg-amber-300/10 rounded-full blur-[100px] animate-pulse"
        style={{ animationDelay: "1s", animationDuration: "4s" }}
      />
      <div
        className="absolute bottom-0 left-1/3 w-[350px] h-[350px] bg-orange-400/10 rounded-full blur-[100px] animate-pulse"

...
export interface InterviewerAvailabilitySlot {
    startTime: Date;
    endTime: Date;
}

export interface InterviewerScheduledBooking {
    startTime: Date;
    endTime: Date;
}
...
export interface InterviewerProfile {
    ...
    creditRate: number;
    availabilities: InterviewerAvailabilitySlot[];
    bookingsAsInterviewer: InterviewerScheduledBooking[];
}
...
export const bookSlot = async ({
    ...
    startTime,
    endTime,
}: BookSlotParams): Promise<BookSlotResult> => {

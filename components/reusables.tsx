...
export const SectionHeading = ({ gray, gold }: SectionHeadingProps) => (
    <h2
...
export default function PageHeader({ label, gray, gold, description, right }: PageHeaderProps) {
    return (
